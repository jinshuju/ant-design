(window.webpackJsonp=window.webpackJsonp||[]).push([[199],{3919:function(h,N,u){h.exports={async:u(4775),basic:u(4776),checkable:u(4777),multiple:u(4778),placement:u(4779),status:u(4780),suffix:u(4781),treeData:u(4782),treeLine:u(4783)}},4775:function(h,N,u){h.exports={content:{"zh-CN":[["p","\u5F02\u6B65\u52A0\u8F7D\u6811\u8282\u70B9\u3002"]],"en-US":[["p","Asynchronous loading tree node."]]},meta:{order:5,title:{"zh-CN":"\u5F02\u6B65\u52A0\u8F7D","en-US":"Asynchronous loading"},filename:"components/tree-select/demo/async.md",id:"components-tree-select-demo-async"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import type { TreeSelectProps } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var S=u(0),O=u(42),i=u(12),d=k(u(0));function k(y){return y&&y.__esModule?y:{default:y}}var f=function(){return d.default.createElement(i.Space,{direction:"vertical",style:{width:"100%"}},d.default.createElement(i.TreeSelect,{status:"error",style:{width:"100%"},placeholder:"Error"}),d.default.createElement(i.TreeSelect,{status:"warning",style:{width:"100%"},multiple:!0,placeholder:"Warning multiple"}))},w=f;return S.createElement(w)}}},4781:function(h,N,u){h.exports={content:{"zh-CN":[["p","\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002"]],"en-US":[["p","The most basic usage."]]},meta:{order:12,debug:!0,title:{"zh-CN":"\u540E\u7F00\u56FE\u6807","en-US":"Suffix"},filename:"components/tree-select/demo/suffix.md",id:"components-tree-select-demo-suffix"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { SmileOutlined } from <span class="token string">'@ant-design/icons'</span><span class="token comment" spellcheck="true">;</span>
import { TreeSelect } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
