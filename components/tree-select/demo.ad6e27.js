...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var S=u(0),O=u(43);function i(a){return i=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},i(a)}var d=u(62),k=u(12),f=y(u(0));function w(a){if(typeof WeakMap!="function")return null;var t=new WeakMap,p=new WeakMap;return(w=function(o){return o?p:t})(a)}function y(a,t){if(!t&&a&&a.__esModule)return a;if(a===null||i(a)!=="object"&&typeof a!="function")return{default:a};var p=w(t);if(p&&p.has(a))return p.get(a);var e={},o=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var c in a)if(c!=="default"&&Object.prototype.hasOwnProperty.call(a,c)){var r=o?Object.getOwnPropertyDescriptor(a,c):null;r&&(r.get||r.set)?Object.defineProperty(e,c,r):e[c]=a[c]}return e.default=a,p&&p.set(a,e),e}function C(a,t){return T(a)||D(a,t)||m(a,t)||A()}function A(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
