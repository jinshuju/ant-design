...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var h=t(0),b=t(42),i=t(62),e=t(12),o=r(t(0));function r(k){return k&&k.__esModule?k:{default:k}}var d=function(){return o.default.createElement(e.Steps,{items:[{title:"Login",status:"finish",icon:o.default.createElement(i.UserOutlined,null)},{title:"Verification",status:"finish",icon:o.default.createElement(i.SolutionOutlined,null)},{title:"Pay",status:"process",icon:o.default.createElement(i.LoadingOutlined,null)},{title:"Done",status:"wait",icon:o.default.createElement(i.SmileOutlined,null)}]})},g=d;return h.createElement(g)}}},4630:function(f,w,t){f.exports={content:{"zh-CN":[["p","\u4FEE\u6539\u6807\u7B7E\u653E\u7F6E\u4F4D\u7F6E\u4E3A ",["code","vertical"],"\u3002"]],"en-US":[["p","Set labelPlacement to ",["code","vertical"],"."]]},meta:{order:14,title:{"zh-CN":"\u6807\u7B7E\u653E\u7F6E\u4F4D\u7F6E","en-US":"Label Placement"},filename:"components/steps/demo/label-placement.md",id:"components-steps-demo-label-placement"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Steps } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var h=t(0),b=t(42),i=t(12),e=o(t(0));function o(k){return k&&k.__esModule?k:{default:k}}var r="This is a description.",d=function(){return e.default.createElement(i.Steps,{direction:"vertical",current:1,items:[{title:"Finished",description:r},{title:"In Progress",description:r},{title:"Waiting",description:r}]})},g=d;return h.createElement(g)}}}}]);
