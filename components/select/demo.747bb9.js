...
`},preview:function(){var N=a(0),$=a(42),h=a(12),u=r(a(0));function r(d){return d&&d.__esModule?d:{default:d}}for(var y=[],R=10;R<36;R++)y.push({value:R.toString(36)+R,label:R.toString(36)+R});var w=function(P){console.log("selected ".concat(P))},A=function(){return u.default.createElement(h.Select,{mode:"tags",style:{width:"100%"},onChange:w,tokenSeparators:[","],options:y})},b=A;return N.createElement(b)}}},4550:function(x,W,a){x.exports={content:{"zh-CN":[["p","\u57FA\u672C\u4F7F\u7528\u3002"]],"en-US":[["p","Basic Usage."]]},meta:{order:0,title:{"zh-CN":"\u57FA\u672C\u4F7F\u7528","en-US":"Basic Usage"},filename:"components/select/demo/basic.md",id:"components-select-demo-basic"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { <span class="token keyword">Select</span> } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
